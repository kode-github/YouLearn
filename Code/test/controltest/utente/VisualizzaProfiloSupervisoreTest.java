...
import control.utente.VisualizzaProfiloServlet;
...
public class VisualizzaProfiloSupervisoreTest extends Mockito{
	...
	public void testServlet() throws Exception {
        ...
        request.setAttribute("idCorso", "10000");

        new VisualizzaProfiloServlet().doPost(request, response);
        	
        verify(response).sendRedirect(request.getContextPath()+"\\HomepageSupervisore.jsp");
    }
	...
	private void createTmpComponentCorso() throws NoPermissionException, NotWellFormattedException, AlreadyExistingException, SQLException, NotFoundException {
		...
		//Account docente
		tmpAccount = new AccountBean("Mario", "Sessa", "PentiumD", "Prova@mail.com", Ruolo.Supervisore, true, tmpCarta);
